        ...
        <div className="w-full py-4 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  lanyard.activities && lanyard.activities.length > 0 ? (
                    lanyard.activities.map((activity: any, idx: number) => (
                      <div key={idx} className="flex items-center gap-3 bg-[#232321] rounded p-2 mb-1">
                        ...
                        <div>
                          <div className="font-medium text-sm text-[#4a4a46]">{activity.name}</div>
                          ...
                          {activity.type === 2 && activity.name === 'Spotify' && lanyard.listening_to_spotify && lanyard.spotify ? (
                            <div className="mt-1 flex items-center gap-2">
                              ...
                              <div>
                                <div className="text-xs font-semibold text-[#1db954]">{lanyard.spotify.song}</div>
                    ...
                    <div className="flex flex-col items-center justify-center h-32 w-full text-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 mb-2 text-[#4a4a46]/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z" />
                      </svg>
                      <span className="text-sm font-medium text-[#4a4a46]/70">
              ...
              <div className="bg-[#1e1e1c] rounded-md border border-[#3a3a36] p-3 hover:border-[#4a4a46]/50 transition-colors h-full flex flex-col group">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  <div className="flex items-baseline">
                    ...
                    <span className="text-xs ml-1 text-[#4a4a46]/50">
            ...
            <div className="sm:col-span-3">
              ...
              >
                ...
                <span className="text-xs transition-colors text-[#4a4a46]/60 group-hover:text-[#4a4a46]">
                  Skills 
                </span>
              </Link>
            </div>
            ...
            <div className="sm:col-span-3">
              <div className="bg-[#1e1e1c] rounded-md border border-[#3a3a36] overflow-hidden">
                ...
                <div className="p-3 font-mono text-xs">
                  ...
                  <div className="pl-4 mt-1 text-[#4a4a46]/80">
                    <div>
                  ...
                  <div className="flex mt-1 items-center">
                    <span className="text-[#4a4a46]/70">$ </span>
                    <span className="relative text-[#4a4a46]">
                      npm start
                      <span className="absolute top-1 right-[-12px] w-2 h-4 animate-pulse-subtle bg-[#4a4a46]/80"></span>
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="flex justify-between items-center border-t pt-4 mt-4 text-xs border-[#3a3a36]">
            <div className="flex items-center h-6 overflow-hidden gap-1">
              ...
              <p className="text-xs text-[#4a4a46]/70">
                Sempre aprendendo, sempre crescendo
              </p>
            </div>
            <a
              href="mailto:marceloexpress9@gmail.com"
              className="px-3 py-1.5 border rounded-sm hover:bg-[#4a4a46] hover:text-[#262624] transition-all flex items-center gap-1.5 border-[#4a4a46]/50 text-[#4a4a46]/80 hover:border-[#4a4a46]"
            >
              <Mail className="w-3.5 h-3.5" />
              <span>Contato</span>
            </a>
